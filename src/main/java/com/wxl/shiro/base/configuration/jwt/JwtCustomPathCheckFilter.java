 ...
 */
@Slf4j
public class JwtCustomPathCheckFilter extends PathMatchingFilter {
    ...
    protected boolean onPreHandle(ServletRequest request, ServletResponse response, Object mappedValue) throws Exception {
        ...
        log.info("Jwt更新权限判断流程....flag===>{}" , flag);
        ...
        if (!flag.equals(time) && !StringUtils.isEmpty(time)) {
            JwtShiroFilterSupport support = ApplicationBeanUtils.getBean(JwtShiroFilterSupport.class);
            try {
